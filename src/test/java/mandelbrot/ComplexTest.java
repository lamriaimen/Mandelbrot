...
public class ComplexTest {
    ...
    void  testSubtract(){
        ...
        assertThat(one.subtract(one)).isEqualTo(zero);
    ...
    void  testMultiply(){
        ...
        assertThat(one.multiply(zero)).isEqualTo(zero);
        assertThat(one.multiply(one)).isEqualTo(one);
        assertThat(oneMinusI.multiply(onePlusI)).isEqualTo(two);
    }
   ...
   @Test
    void testSquaredModulus(){
        ...
        assertThat(one.squaredModulus()).isEqualTo(1);
...
@Test
    void testPow(){
    assertThat(one.pow(2)).isEqualTo(one);

    assertThat(new Complex(1,1).pow(2)).isEqualTo(twoI);
    assertThat(new Complex(1,-1).pow(2)).isEqualTo(twoI.negate());

    }
@Test
    void testScale(){

assertThat(onePlusI.scale(2)).isEqualTo(new Complex(2,2));
